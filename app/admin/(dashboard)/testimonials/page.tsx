    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Manage client reviews, ratings, and featured status. Drag to reorder.</p>
        </div>
        {isHigh && (
      ...
      {error && <div className="p-6 text-red-400 text-sm bg-slate-900 border border-slate-800 rounded-2xl">Error loading testimonials: {error.message}</div>}
